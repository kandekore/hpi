// src/components/SubPricing.js

import React from 'react';

export default function SubPricing({ product, onClose, onPurchase }) {
  // product => "VDI", "Valuation", or "MOT"
  let title = '';
  let deals = [];
          ...
          {deals.map((deal) => (
            <div key={deal.quantity} style={styles.dealBox}>
              ...
              <button
                ...
                onClick={() => onPurchase(product, deal.quantity)}
              >
                Buy
              </button>
            </div>
